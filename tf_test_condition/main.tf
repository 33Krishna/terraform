...
resource "aws_instance" "myserver" {
  ...
  associate_public_ip_address = false # ethi forcefully ame public subnet ku off karuche
  ...
  lifecycle {
    ...
    postcondition {
      condition     = self.public_ip != "" # existing ec2 re public subnet present rahibani
